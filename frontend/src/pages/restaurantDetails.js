    ...
    render() {
        ...
        return (
            <div >
                ...
                <div>
                    <div><span className="boldText">Name:</span> {Name}</div>
                    <div><span className="boldText">Address:</span> {Address}</div>
                    <div><span className="boldText">Description:</span> {Description}</div>
